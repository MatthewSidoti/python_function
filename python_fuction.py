...
# Test the function with examples and print the results
print('Exercise 8:', product(2, 5, 5))  # Should return 50
print('Exercise 8:', product(-1, 4))  # Should return -4
print('Exercise 8:', product(3, 7, 2, 1))  # Should return 42
...
print('Exercise 9 Result (subtract):', basicCalculator(10, 5, "subtract")) 
print('Exercise 9 Result (add):', basicCalculator(10, 5, "add"))  
print('Exercise 9 Result (multiply):', basicCalculator(10, 5, "multiply")) 
print('Exercise 9 Result (divide):', basicCalculator(10, 5, "divide"))  
print('Exercise 9 Result (divide by zero):', basicCalculator(10, 0, "divide"))  
print('Exercise 9 Result (unsupported operation):', basicCalculator(10, 5, "modulus"))  
